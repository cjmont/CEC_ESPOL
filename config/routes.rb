Rails.application.routes.draw do
  ...
  get 'curso' => 'pages#shop'
  get 'cliente' => 'pages#cliente'
  ...
  get 'infoprograma' => 'pages#infoprograma'
  get 'conferencia' => 'pages#seminario'
  get 'capacitaciones' => 'pages#capacitaciones'
  get 'sedes' => 'pages#sedes'
  get 'identidad' => 'pages#identidad'
  get 'certificaciones' => 'pages#certificaciones'
  get 'contactenos' => 'contacts#new'
  get 'inscripcion' => 'pedidos#new'
  
  
  resources :infoprograma
  resources :infocurso
